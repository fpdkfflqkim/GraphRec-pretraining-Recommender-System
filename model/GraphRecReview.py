...
class Model(nn.Module):
    def __init__(
        ...
        r2e = embedding_dict
        self.enc_u = UI_Aggregator(
            i2e, r2e, u2e, embed_dim, history_u, history_ue, cuda, user=True
        )
        self.enc_i = UI_Aggregator(
            i2e, r2e, u2e, embed_dim, history_i, history_ie, cuda, user=False
        )
