...
class Model(nn.Module):
    def __init__(
        ...
        self.enc_u = UI_Aggregator_rating(
            i2e, r2e, u2e, embed_dim, history_u, history_ur, cuda, user=True
        )
        self.enc_i = UI_Aggregator_review(
            i2e, emb_dict, u2e, embed_dim, history_i, history_ie, cuda, user=False
        )
