...
parser.add_argument(
    "--data_path", default="data/ciao/preprocess/", help="dataset directory path"
)
...
parser.add_argument(
    "--embed_dim", type=int, default=384, help="the dimension of embedding"
)
parser.add_argument(
    "--epochs", type=int, default=30, help="the number of epochs to train for"
)
